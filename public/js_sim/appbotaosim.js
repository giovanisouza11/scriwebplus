...
function Sim_Botao_Click() {
	...
	if (Sim_Edicao==0 && Sim_Botao_Funcao[3]==1){
		...
		*/
		...
		{    img.file(Sim_Path + ArrayImagens[ArrayObjDinamic[(aux1)*10+5]] + Extensao[ArrayObjDinamic[(aux1)*10+1]] + '.png', Imagens[aux1]); 
		}*/
		/*
	...
	if (Sim_Edicao==0 && Sim_Botao_Funcao[4]==1){
		...
		modalb1.innerHTML += "<p><a href='http://scriwebplus.herokuapp.com/ftp/Classificacao/Classificacao.csv'>Classificação</a></p>";
		modalb1.innerHTML += "<p><a href='http://scriwebplus.herokuapp.com/ftp/Corte_Vinco/Corte_Vinco.csv'>Corte e Vinco</a></p>";
		modalb1.innerHTML += "<p><a href='http://scriwebplus.herokuapp.com/ftp/Dosagem/Dosagem.csv'>Dosagem</a></p>";
		modalb1.innerHTML += "<p><a href='http://scriwebplus.herokuapp.com/ftp/Desbobinador/Desbobinador.csv'>Desbobinador</a></p>";
		modalb1.innerHTML += "<p><a href='http://scriwebplus.herokuapp.com/ftp/Elevador/Elevador.csv'>Elevador(3 andares)</a></p>";
		modalb1.innerHTML += "<p><a href='http://scriwebplus.herokuapp.com/ftp/Elevador5/Elevador5.csv'>Elevador(5 andares)</a></p>";
		modalb1.innerHTML += "<p><a href='http://scriwebplus.herokuapp.com/ftp/Envase/Envase.csv'>Envase</a></p>";
