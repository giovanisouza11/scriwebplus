...
function tBotao() {
	...
	if (simEdicao==0 && valor_chave[3]==1){
			...
			if (ArrayObjStatic[(i*20)+17]>1 && ArrayObjStatic[(i*20)+17]<5) {
				...
				if (Imagens_Real[ArrayObjDinamic[i*10+5]].data.lenght > 1 )
					texto += Imagens_Real[ArrayObjDinamic[i*10+5]].data.join('.'); 
				texto += ',';
				if (Imagens1_Real[ArrayObjDinamic[i*10+5]].data.lenght > 1)
					texto += Imagens1_Real[ArrayObjDinamic[i*10+5]].data.join('.');
				texto += ',';
				if (Imagens2_Real[ArrayObjDinamic[i*10+5]].data.lenght > 1)
