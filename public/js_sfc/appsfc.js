	...
	if (event.keyCode == 13) { //Tecla enter
		...
		if (lFuncaoSfc < 3) {
			...
			if (emEdicao == 6) {
				...
				contextSfc.fillStyle = 'cyan';
				contextSfc.fillText(tag,(estadoX0+((posicaoXSfc-estadoX0)/2))*60, (estadoY0+((posicaoYSfc-estadoY0)/2)+1)*60+52);
			...
			if (emEdicao == 3) {
				...
				contextSfc.fillStyle = 'cyan';
				contextSfc.fillText(tag,(estadoX0+((posicaoXSfc-estadoX0+1)/2))*60, (estadoY0+((posicaoYSfc-estadoY0)/2))*60+22);
