	...
	if (event.keyCode == 13) { //Tecla enter
		...
		if (lFuncaoSfc < 3) {
			if (emEdicao == 7) {
				...
				contextSfc.fillText(tag,(estadoX0+((posicaoXSfc-estadoX0+1)/2))*60, (estadoY0+((posicaoYSfc-estadoY0)/2))*60+30);
				ICampo.style.display = "none";
				ICampo.style.top = "680px";
				ICampo.style.left = "100px";
				CInput.blur();
			...
			if (emEdicao == 6) {
				...
				contextSfc.fillStyle = 'cyan';
				contextSfc.fillText(tag,(estadoX0+((posicaoXSfc-estadoX0+1)/2))*60, (estadoY0+((posicaoYSfc-estadoY0)/2))*60+25);
			...
			if (emEdicao == 5) {
				...
				contextSfc.fillStyle = 'cyan';
				contextSfc.fillText(tag,(estadoX0+((posicaoXSfc-estadoX0+1)/2))*60, (estadoY0+((posicaoYSfc-estadoY0)/2))*60+20);
